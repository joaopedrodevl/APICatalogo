...
namespace APICatalogo.Migrations
{
    ...
    public partial class PopulaProdutos : Migration
    {
        ...
        {
            mb.Sql("INSERT INTO Produtos(Nome, Descricao, Preco, ImageUrl, Estoque, DataCadastro, CategoriaId) VALUES('Coca-Cola Diet', 'Refrigerante de Cola 350ml', 5.45, 'cocacola.jpg', 50, now(), 1)");
